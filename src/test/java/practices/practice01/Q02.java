...
public class Q02 {
    ...
    // Wait for 3 seconds
    // Close the browser
    //medunna.commedunna.com
            //MEDUNNA
   // Description for hospitalmsappfrontend
    public static void main(String[] args) throws InterruptedException {
        ...
        // Get the title and URL of the page//String value return
        ...
        if(techproTitle.contains("Bootcamps")){
            ...
            System.out.println("Title does not cointens Bootcamps");
        }
        ...
        // Get the title and check if it contains the word "MEDUNNA" and print "Title contains MEDUNNA" or "Title does not contain MEDUNNA"
       String menunnaTitle= driver.getTitle();
       if(menunnaTitle.contains("MEDUNNA")){
